package me.segalu.udemymod.world.structure
...
class SkyStructures : StructureFeature<JigsawConfiguration>(
    JigsawConfiguration.CODEC,
    SkyStructures::createPiecesGenerator,
    ...
    companion object {
        private fun isFeatureChunk(context: PieceGeneratorSupplier.Context<JigsawConfiguration>): Boolean {
            ...
            return !context.chunkGenerator.hasFeatureChunkInRange(
        ...
        fun createPiecesGenerator(context: PieceGeneratorSupplier.Context<JigsawConfiguration>): Optional<PieceGenerator<JigsawConfiguration>> {
            ...
            var blockPos = context.chunkPos.getMiddleBlockPosition(0)
            ...
            val topLandY = context.chunkGenerator.getFirstFreeHeight(
            ...
            val structurePiecesGenerator = JigsawPlacement.addPieces(
                context,// Used for JigsawPlacement to get all the proper behaviors done.
                ::PoolElementStructurePiece, // Needed in order to create a list of jigsaw pieces when making the structure's layout.
